...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-gf p-1 text-zinc-500 opacity-70 transition-opacity hover:bg-brand-800/60 hover:text-zinc-200 hover:opacity-100 focus:outline-none">
        <X className="h-4 w-4" />
